...
String _$favoriteRepositoryHash() =>
    r'32d745d3bd05a841c71940f0b6cdd31e8921dfb8';
...
String _$myFavoriteHash() => r'69fba8b41fce0743009bb7a3178d9ec5cd7f2871';

/// See also [myFavorite].
@ProviderFor(myFavorite)
final myFavoriteProvider =
    AutoDisposeFutureProvider<List<FavoriteStoreListDTO>>.internal(
      myFavorite,
      name: r'myFavoriteProvider',
      debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
          ? null
          : _$myFavoriteHash,
      dependencies: null,
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef MyFavoriteRef =
    AutoDisposeFutureProviderRef<List<FavoriteStoreListDTO>>;
